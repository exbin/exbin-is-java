...
public class ExbinService {
    ...
    public static void main(String[] args) {
        try {
            final ResourceBundle recourceBundle = ResourceBundle.getBundle("org/exbin/is/service/ExbinService");
            final Preferences preferences = Preferences.userNodeForPackage(ExbinService.class);
            ...
            if (cl.hasOption('h')) {
                ...
                Logger.getLogger(ExbinService.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, recourceBundle.getString("service_head"));
                ...
                if (devMode) {
                    Logger.getLogger(ExbinService.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "Set development mode.");
                }
                boolean rootCatalogMode = cl.hasOption("rootcat");
                if (rootCatalogMode) {
                    Logger.getLogger(ExbinService.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "Set root catalog mode.");
                }
//                if (cl.hasOption("nopref"))
                ...
                ExbinServiceInstance server = new ExbinServiceInstance();
            ...
            Logger.getLogger(ExbinService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
