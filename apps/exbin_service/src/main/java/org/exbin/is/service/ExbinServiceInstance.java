...
public class ExbinServiceInstance {
    ...
    private ResourceBundle resourceBundle = ResourceBundle.getBundle("org/exbin/is/service/ExbinService");
    ...
    public ExbinServiceInstance() {
    }

    public void run() {
        Logger.getLogger(ExbinService.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("service_head"));
        Logger.getLogger(ExbinService.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
        ...
        try {
            ...
            Logger.getLogger(ExbinServiceInstance.class.getName()).log(Level.SEVERE, "{0}{1}: {2}", new Object[]{resourceBundle.getString("error_warning"), resourceBundle.getString("error_tcpip_port"), tcpipPort});
        }
        ...
        try {
            ...
            serviceServer.run();
            Logger.getLogger(ExbinServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, (resourceBundle.getString("stop_service_success") + "."));
        } catch (IOException e) {
            Logger.getLogger(ExbinServiceInstance.class.getName()).log(Level.WARNING, (resourceBundle.getString("init_service_failed") + ": " + e));
        }
    }
    ...
    private void performUpdate() {
        ...
        try {
            ...
            if (shallUpdate) {
                ...
                Logger.getLogger(ExbinServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("init_update"));
                Logger.getLogger(ExbinServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
                ...
                Logger.getLogger(ExbinServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
                Logger.getLogger(ExbinServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("done_update"));
                Logger.getLogger(ExbinServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
            }
